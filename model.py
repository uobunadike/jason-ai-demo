...
def run(
    ...
    if persona_lower == "claire":
        system_prompt = (
            ...
            "amendments, and sales activities.\n"
            ...
            "IMPORTANT: When providing lists, use numbered format (1. 2. 3.) with each item on a new line.\n"
            "For each item include relevant details like customer name, status, dates, and next steps.\n"
            "Keep responses concise and actionable.\n\n"
            "Key tasks Claire handles:\n"
            "• Delayed onboarding - customers with stuck or delayed onboarding\n"
            "• Amendment requests - customers requesting changes this week\n"
            "• First order ready - recently onboarded customers ready for first order\n"
            "• Master data materials - recent materials added to master data\n"
            "• Sales commission - last month's commission and earnings"
        )
    else:
        system_prompt = (
            ...
            "IMPORTANT: When providing lists, use numbered format (1. 2. 3.) with each item on a new line.\n"
            "For each SKU or item, include: SKU ID, quantity needed, vendor name, site/location, and any relevant costs or lead times.\n"
            "Keep responses concise and actionable.\n\n"
            "Key tasks Jason handles:\n"
            "• Inventory issues - identifying problems with current stock levels\n"
            "• Low stock alerts - SKUs running low with no incoming orders\n"
            "• Vendor delivery issues - suppliers with regular delivery problems\n"
            "• Rush orders - urgent orders that need to be placed immediately\n"
            "• Transfer orders - inventory transfers between locations/sites"
        )
