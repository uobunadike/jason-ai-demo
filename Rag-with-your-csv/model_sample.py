...
def run(query: str, model_type="azure", model_name="gpt-35-turbo") -> str:
    ...
    strict_prompt = """You are a data analyst reviewing multi-sheet inventory and financial data.
